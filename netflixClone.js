...
const requests = {
    fetctTrending: `${base_url}/trending/all/week?api_key=${api_key}&language=en-US`,
    fetctNetflixOrignals: `${base_url}/discover/tv?api_key=${api_key}&with_networks=213`,
    fetctActionMovies: `${base_url}/discover/movie?api_key=${api_key}&with_genres=28`,
    fetctComedyMovies: `${base_url}/discover/movie?api_key=${api_key}&with_genres=35`,
    fetctHorrorMovies: `${base_url}/discover/movie?api_key=${api_key}&with_genres=27`,
    fetctRomanceMovies: `${base_url}/discover/movie?api_key=${api_key}&with_genres=10749`,
    fetctDocumentaries: `${base_url}/discover/movie?api_key=${api_key}&with_genres=99`,
};
...
function createAndAppendMovies(results, title) {
    ...
    rowPosters.classList.add("d-flex", "flex-row", "overflow-auto");
    let count = 0;
